...
<body>
  <a href="#main-dark" class="skip-link link-light" aria-label="Skip to main content">Skip to main content</a>
  <a href="#main-light" class="skip-link link-dark" aria-label="Skip to main content">Skip to main content</a>
    ...
    <header>
      ...
      <nav id="nav-light" class='nav-style'>
        <ul>
          ...
          <li class="nav_active"><a href="jobs#light">Jobs<img class="icon" src="/images/icons/jobs-icon-light.png"
                alt=""></a></li>
      ...
      <nav id="nav-dark" class='nav-style'>
        <ul>
          ...
          <li class="nav_active"><a href="jobs#dark">Jobs<img class="icon" src="/images/icons/jobs-icon-dark.png"
                alt=""></a></li>
          <li><a href="/apply#dark">Apply<img class="icon" src="/images/icons/apply-icon-dark.png" alt=""></a>
          </li>
          <li><a href="/about#dark">About<img class="icon" src="/images/icons/about-icon-dark.png" alt=""></a>
          </li>
        </ul>
      </nav>
    </header>
